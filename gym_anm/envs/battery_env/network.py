...
network["device"] = np.array([
    [0, 0, 0, None, 5, -5, 5, -5, None, None, None, None, None, None, None],
    [1, 0, 2, None, 50, 0, 50, -50, 35, None, 20, -20, None, None, None],
    [2, 1, -1, 0.2, 0, -30, None, None, None, None, None, None, None, None, None],
    [3, 1, 3, None, 50, -50, 50, -50, 30, -30, 25, -25, 200, 0, 0.9]
])

network["branch"] = np.array([
    [0, 1, 0.0303, 0.0611, 0., 25, 1, 0]
])