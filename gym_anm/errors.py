"""Error types for :code:`gym_anm`."""


class ANMEnvConfigurationError(Exception):
    """A base class for exceptions relative to the construction of a gym_anm env."""
    pass
...
class ObsNotSupportedError(ObsSpaceError):
    ...
    def __init__(self, wanted, allowed):
        super().__init__('Observation type unsupported. Desired {} but we only '
